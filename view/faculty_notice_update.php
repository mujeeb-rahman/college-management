<!-- to update notices for particular department in faculty side -->
<?php
    session_start();
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                        <div class="form-group"><label class="small mb-1" for="inputEmailAddress">ID</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter name" name="tid" value="<?php echo $row['nid']; ?>" readonly/></div>
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Title</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter Tiltle" name="title" value="<?php echo $row['title']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Beginning Date</label><input class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter beginning date" name="bdate" value="<?php echo $row['sdate']; ?>" required><div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">End Date</label><input class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter end date" name="edate"value="<?php echo $row['edate']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Description</label><textarea class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter description" name="desc"value="" required><?php echo $row['description']; ?></textarea></div>
