<!-- faculty registration in administration side -->
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $obj -> AdminFacultyRegister($name,$address,$gender,$dob,$mobile,$email,$dept,$pword);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Department to assign" name="dept" required/></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
