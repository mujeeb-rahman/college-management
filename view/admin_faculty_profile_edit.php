<!-- faculty profile edit in administration side -->
<?php
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Department to assign" name="dept" value="<?php echo $row['fdept']; ?>" required/></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
