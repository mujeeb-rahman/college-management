<!-- to edit timetable for particular department foe specified semester in faculty side -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Id</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="" name="tid" value="<?php echo $row['tid'];?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter registration number" name="sdept" value="<?php echo $row['dept_name'];?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Semester No.</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="" name="sno" value="<?php echo $row['semester_no']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Day</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter day" name="day" value="<?php echo $row['day']; ?>" required></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Hour 1</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject" name="h1" value="<?php echo $row['hour1']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Hour 2</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject" name="h2" value="<?php echo $row['hour2']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Hour 3</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject" name="h3" value="<?php echo $row['hour3']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Hour 4</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject" name="h4" value="<?php echo $row['hour4']; ?>" required/></div>
