<!-- to create new notices for particular department in faculty side -->
<?php
    session_start();
    ...
    if(isset($_POST['submit']))
    {
        ...
        $edate = $_POST['edate'];
        $desc = $_POST['desc'];
        $obj -> FacultyNoticeNew($author,$fdept,$title,$bdate,$edate,$desc);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Author</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter name" name="author" value="<?php echo $_SESSION['author']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter department" name="fdept" value="<?php echo $_SESSION['fdept']; ?>" readonly/></div>
