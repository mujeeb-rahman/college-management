<!-- to edit student profile in student side -->
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $obj -> StudentProfileUpdate($regid,$name,$address,$gender,$dob,$mobile,$email,$dept,$pword);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Registration ID</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter name" name="fid" value="<?php echo $row['sreg_no']; ?>" readonly/></div>
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label><input class="form-control py-4" id="inputEmailAddress" type="email" aria-describedby="emailHelp" placeholder="Enter email address" name="email" value="<?php echo $row['smail']; ?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Department to assign" name="dept" value="<?php echo $row['sdept']; ?>" readonly/></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="inputPassword">Password</label><input class="form-control py-4" id="inputPassword" type="password" placeholder="Enter password" name="password" value="<?php echo $row['spassword']; ?>" required/></div>
                                                </div>
                                                <div class="col-md-6">
