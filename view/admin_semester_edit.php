<!-- to edit semester details in administration side -->
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $s3 = $_POST['s3'];
        $s4 = $_POST['s4'];
        $obj -> AdminSemesterUpdate($sid,$dname,$sno,$s1,$s2,$s3,$s4);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Semester Id</label><input class="form-control py-4" id="inputEmailAddress" type="number" aria-describedby="nameHelp" placeholder="Semester Id" name="sid" value="<?php echo $row['sid']; ?>" readonly/></div>
                                            ...
                                            <div class="drop-down form-control">
                                                <select name="dname" required>
                                                    <option selected value="<?php echo $row['dept_name']; ?>"><?php echo $row['dept_name']; ?></option>
